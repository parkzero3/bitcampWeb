...
<div class="container">
	<h1>글수정 폼</h1>
	<form method="post" action="/bitcamp/freeboard/boardEditOk.jsp?nowPage=<%=nowPage %>" id="boardFrm">
	...
	<div>
		<a href="/bitcamp/index.jsp">홈</a>
		<a href="/bitcamp/freeboard/boardList.jsp?nowPage=<%=nowPage%>">게시판 목록</a>
	</div>	
</div>
</body>
</html>
<% }else{ 
	response.sendRedirect("/bitcamp/response/login.html");
	}%>