...
<div class="container">
	<h1>글쓰기폼</h1>
	<form method="post" action="/bitcamp/freeboard/boardWriteOk.jsp" id="boardFrm">
	...
	<div>
		...
		<a href="/bitcamp/freeboard/boardList.jsp">게시판 목록</a>
	</div>	
</div>
</body>
</html>
<% }else{ 
	response.sendRedirect("/bitcamp/response/login.jsp");
	}%>